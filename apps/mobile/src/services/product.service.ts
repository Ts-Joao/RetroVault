...
export const mockProducts: Product[] = [
  {
    ...
    price: 353.30,
    photo: require('../../assets/image/f1-25.webp'),
    seller_id: '2',
    rating: 4.5,
    max_installments: 12,
  ...
  },
  {
    ...
    price: 154,
    photo: require('../../assets/image/shadow-of-the-colossus.png'),
    seller_id: '2',
    rating: 4,
    max_installments: 6,
    free_installments: 3,
  ...
  },
  {
    ...
    price: 380.37,
    photo: require('../../assets/image/pokemon-legends-za.webp'),
    seller_id: '3',
    rating: 5,
    max_installments: 12,
    free_installments: 8,
  ...
  },
  {
    ...
    price: 409.11,
    photo: require('../../assets/image/zelda-breath-of-the-wild.webp'),
    free_installments: 2,
    max_installments: 6,
    min_installment_amount: 20,
    monthly_interest_rate: 0.02,
  ...
  },
  {
    ...
    price: 224.00,
    photo: require('../../assets/image/metal-gear-solid-v-the-phantom-pain.ps4.webp'),
    free_installments: 3,
    max_installments: 6,
    min_installment_amount: 20,
  ...
  },
  {
    ...
    price: 251.00,
    photo: require('../../assets/image/sonic-x-shadow-generations.nintendo-switch.webp'),
    free_installments: 2,
    max_installments: 8,
    min_installment_amount: 10,
    monthly_interest_rate: 0.05,

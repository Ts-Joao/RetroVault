                    ...
                    {user ? (
                        ...
                        >
                            ...
                            <div className="hidden lg:flex flex-col leading-tight">
                                <span className="text-xs font-black uppercase tracking-tight text-white truncate max-w-[140px]">
                                    {profile?.name ?? user.name ?? "Usuário"}
                                </span>
                                <span className="text-[10px] text-emerald-300 font-bold uppercase mt-0.5 tracking-wider">Online</span>
                            </div>
                        </Link>
                    ) : (
                        <Link 
                            href='/login'
                            className="flex items-center gap-2 px-5 py-2.5 bg-[#CD463A] hover:bg-[#DC5246] text-white rounded-xl font-black uppercase tracking-wider text-sm transition-all active:scale-95 shadow-sm"
                        >
                            <PiUserPlusBold className="text-xl text-white" />

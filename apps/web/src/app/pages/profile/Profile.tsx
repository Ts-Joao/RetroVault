...
export default function Profile() {
 return (
  <>
   <div className="bg-amber-950 flex flex-col my-20 mx-50 border-2 border-[#BF372A] rounded-xl">
    <Image
    ...
    <div className="bg-[#E3E2E2] grid grid-cols-4 justify-items-center p-10 rounded-b-xl gap-y-3">
